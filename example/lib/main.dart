...
class SelectedTheme {
  ...
  factory SelectedTheme.standard() =>
      SelectedTheme._(YaruTheme.standard, 'standard');

  /// a factory for a `SelectedTheme` that holds `yaru.darkTheme`
  factory SelectedTheme.dark() => SelectedTheme._(YaruTheme.dark, 'dark');

  /// a factory for a `SelectedTheme` that holds `yaru.lightTheme`
  factory SelectedTheme.light() => SelectedTheme._(YaruTheme.light, 'light');
}
